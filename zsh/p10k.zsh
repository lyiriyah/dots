# Generated by Powerlevel10k configuration wizard on 2020-10-16 at 17:44 BST.
...
# dotted, left frame, light-ornaments, sparse, few icons, fluent, transient_prompt,
...
() {
  ...
  # rjight prompt on the last prompt line (where you are typing your commands) gets
  ...
  #   # Wifi colors and icons for different signal strength levels (low to high).
      typeset -g my_wifi_fg=(196 166 142 130 46)               # <-- change these values
